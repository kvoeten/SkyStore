...
const GENERAL_MENU_RATES: readonly ExactRate[] = [
  ...
  ["Steamed Mudcrab", 9, 1, ["Steamed Mudcrab Legs"]], ["Roasted Goat Leg", 6, 1, ["Leg of Goat Roast"]], ["Mammoth Steak", 9], ["Apple Cabbage Stew", 5],
  ...
  ["Jazbay Crostata", 16], ["Juniper Crostata", 17, 1, ["Juniper Berry Crostata"]], ["Lavender Dumpling", 29], ["Potato Bread", 19],
...
export function resolvePublishedPriceGuide(items: readonly PublishedCatalogItem[]) {
  ...
  resolveExact(items, GENERAL_MENU_RATES, "customer_pays", generalMenu, GENERAL_STORE_URL, resolved, unresolved);
